...
import handleStartCaptureClick from '../charts/Sparkline/index';
...
const fetchBellData = () => {
      return axios.get("https://home-sec.onrender.com/api")
            .then((response) => {
            //   console.log("Bell",response.data.bell)
			console.log(response.data);
			if(response.data.bell == 1){
...
// const bellTimer = async  	setInterval(() => {
// 	const data = await fetchBellData(); 
// 	console.log(data);
// 	if( data.bell== '1'){
// 		window.location.href="http://localhost:3000/react/demo/chart-chartjs";
// 	}
					...
					<div className="card gradient-1 card-bx">
						<div className="card-body d-flex align-items-center">
							<div className="me-auto text-white">
								{/* <a><h2 className="text-white" onClick={window.location.href="http://localhost:3000/react/demo/chart-sparkline"}>Go Live</h2></a> */}
							</div>
                <Button variant="light-blue" className='text-white' style={{fontSize:"35px", fontFamily: 'Poppins'}} >Go Live</Button>
